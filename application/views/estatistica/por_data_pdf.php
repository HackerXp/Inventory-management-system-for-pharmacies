...
$pdf->AddPage();
$pdf->SetTitle('Gest-Farma | Relatório de vendas por data');
...
$cabecalho .= 'ORGÃOS AUXILIARES DO PRESIDENTE DA REPÚBLICA<br>CASA DE SEGURANÇA<br>UNIDADE DE SEGURANÇA PRESIDENCIAL<br>FARMÁCIA<br><br><br><br><span style="font-family: Trebuchet MS;font-size: large">Relatório de vendas no período de '.date("d-m-Y",strtotime($data1)).' à '.date("d-m-Y",strtotime($data2)).'</span>';
