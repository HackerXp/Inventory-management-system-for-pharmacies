...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fa fa-bar-chart'></i> Estatística de vendas por intervalo de datas
        </h1>
    ...
    <div class="row">
        <div id="panel-9" class="panel mt-1 rounded-0 col-3">
            ...
            <div class="panel-container">
                ...
                <div class="col-12 text-right">
                    <div class="p-0">
                        <span class="btn btn-info btn-buscar-por-data"><i class="fa fa-search"></i> Buscar</span>
                    </div>
                </div>
            </div>
        </div>
        <div id="panel-9" class="panel mt-1 rounded-0 col-6">
            <div class="panel-hdr">
                <h2>
                    <i class="fa fa-bar-chart mr-1"></i> <span>Gráfico de Vendas</span>
                </h2>
            </div>
            <div class="panel-container show">
                <div class="panel-content">
                    <div id="venda_por_data" class="ct-chart" style="width:100%; height:300px;"></div>
                </div>
            </div>
        </div>
        <div id="panel-9" class="panel mt-1 rounded-0 col-3">
            <div class="panel-hdr">
                <h2></h2>
                <span data1="" data2="" class="btn-link-por-data" href="<?= site_url('estatistica/por_data/') ?>">
