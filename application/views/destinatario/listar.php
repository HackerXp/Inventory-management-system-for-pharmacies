                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    foreach ($menus as $menu) {
                                        ...
                                        if (strtolower($menu->nome) != strtolower("destinatário")) continue;
                                        ?>
                                        ...
                                        foreach ($sub_menu as $sub) {
                                            ...
                                            if ($sub->modal != 1) {
                                                ...
                                                <a data-toggle="modal"
                                                   ...
                                                   titulo="Desejas realmente elminar este destinatário?"
                                                   cod="<?= $res->id ?>" url="<?= site_url('destinatario/'.$sub->accao) ?>"
