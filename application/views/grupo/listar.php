	...
	<div class="row">
		<div class="col-xl-12">
			<div id="panel-1" class="panel">
				<div class="panel-hdr">
					<h2>
						Listar <span class="fw-300">Grupo</span>
					</h2>
				</div>
							...
							<tbody
								{grupo}
									<tr class="text-center">
										...
										<td>{data_criacao}</td>
										<td>
											<a class="btn btn-xs btn-info waves-effect waves-themed" title="Adicionar Privilégios" href="<?= site_url('grupo/add_privilegio/{id}')?>"><i class="fa fa-cogs text-white"></i></a>
